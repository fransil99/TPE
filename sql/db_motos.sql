...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-10-2022 a las 23:02:40
...
INSERT INTO `marcas` (`id_marca_fk`, `nombre_marca`, `descripcion_marca`, `imagen_marca`) VALUES
...
(7, 'Honda CRF 250F', 'https://a5i4f6g5.stackpathcdn.com/images/cms/Honda-CRF-25.png', 'La CRF 250F cuenta con los gráficos de la última generación de la línea CRF. Su protagonismo en las rutas será contundente dando mucho de que hablar. El nivel de acabados, la calidad de los plásticos y su chasis expuesto harán que la nueva CRF 250F sea el centro de atracción.', 250, 4899, 3),
(8, 'Honda CRF 250R', 'https://a5i4f6g5.stackpathcdn.com/images/cms/CRF250.png', 'El control de lanzamiento de tres niveles de la CRF 250R ofrece opciones para lograr la mejor salida posible tanto para un profesional como para un principiante.', 250, 8199, 3),
(9, 'Honda CRF 450R', 'https://a5i4f6g5.stackpathcdn.com/images/cms/Honda-CRF-450R.png', 'El chasis de doble viga de aluminio ha disminuido su rigidez lateral para contribuir a la maniobrabilidad, sobre todo, en curva. También su distancia libre al piso y la precisión de su geometría de dirección permiten que el desempeño de esta motocicleta sea alusinante en la pista.', 450, 9599, 3),
...
(19, 'Kawasaki KX 250', 'images\\KAWASAKI KX 250.png', 'La KX250 es la máquina probada en campeonatos que hemos construido para que tú puedas ser el siguiente. Sé el próximo campeón. Sé el próximo héroe. Sé la próxima leyenda. Sé el próximo pionero de toda una generación de grandeza. En la KX250, tu momento es\r\nahora. Con: nuevo motor de 4 tiempos más potente de 249 cc, nuevo embrague hidráulico de disco cónico, nuevo arranque eléctrico, nuevo y delgado bastidor perimetral de aluminio.', 250, 9399, 7),
(20, 'Kawasaki KX 450', 'images\\KAWASAKI KX 450.png', 'Con más campeonatos de Supercross y Motocross que cualquier otro fabricante, el nombre KX es\r\nsinónimo de victoria. La KX450 representa el buque insignia de la gama KX, construida con el único propósito de dominar la pista. Durante las últimas cuatro décadas, hemos aprendido lo que se necesita para ganar y mantenerse en la cima. Nuestra dedicación a la construcción de la máquina definitiva es innegable, y la KX450 lo representa al máximo.', 450, 12399, 7),
(21, 'Suzuki RM-Z250', 'https://moto.suzuki.es/assets/images/listado_motos/2018/227x172_RM-Z250_L8_YU1_D.png', 'Prestaciones ganadoras en competición a punto para ti. Un motor de 249 cc con inyección electrónica y un impresionante par motor a bajo y medio régimen y una excitante potencia a altas revoluciones. Una parte ciclo revisada con todo lo aprendido en las carreras. Una imagen agresiva, esbelta y atractiva. La RM-Z250, la perfecta moto de competición para los pilotos de motocross de todo el mundo.', 250, 8700, 8),
(22, 'Suzuki RM-Z450', 'https://moto.suzuki.es/assets/images/listado_motos/2018/RM-Z450L8_YU1_Diagonal.png', 'La Suzuki RM-Z450 son palabras mayores. La más potente y la más emocionante. Ofrece una entrada y salida de las curvas con precisión y estabilidad gracias a sus amortiguaciones hidráulicas.Toda la potencia con el nuevo refinado de motor de 4 tiempos y el escape que la dotan de un altísimo nivel de prestaciones y la convierten en una máquina a la altura de los campeones.', 450, 9039, 8);
...
--
ALTER TABLE `marcas`
  MODIFY `id_marca_fk` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `motos`
--
ALTER TABLE `motos`
  MODIFY `id_moto` int(45) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `motos`
  ADD CONSTRAINT `id_marca_fk` FOREIGN KEY (`id_marca_fk`) REFERENCES `marcas` (`id_marca_fk`);
COMMIT;
